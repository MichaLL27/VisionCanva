            ...
            <div className="bg-white p-6 rounded-3xl shadow-xl border border-primary/10 sticky top-6">
              ...
              <div className="space-y-4">
                <Link href="/print/options">
                  <button className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-3 cursor-pointer">
                ...
                <Link href="/create">
                  <button className="w-full bg-secondary hover:bg-secondary/80 text-foreground font-semibold py-4 px-6 rounded-xl transition-all flex items-center justify-center gap-3 cursor-pointer">
