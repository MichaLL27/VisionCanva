  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <nav className="p-6 flex justify-between items-center max-w-7xl mx-auto">
        <div className="font-display font-bold text-2xl tracking-tight text-primary">VisionAI</div>
        <Link href="/create">
          <button className="bg-white hover:bg-gray-50 text-foreground font-medium py-2 px-6 rounded-full border shadow-sm transition-colors cursor-pointer">
            Sign In
          </button>
        </Link>
      </nav>
      ...
      {/* Hero Section */}
      <main className="max-w-7xl mx-auto px-6 py-12 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
        <motion.div 
